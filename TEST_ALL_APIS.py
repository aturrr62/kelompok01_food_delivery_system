...
def colorize(text: str, color: str) -> str:
    ...
    return text  # Return plain text to avoid encoding issues
    ...
    if login_test:
        ...
        if passed:
            try:
                ...
                print(f"{colorize(' Could not extract token from login response', 'YELLOW')}\n")
        else:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"\n{colorize(' Test interrupted by user', 'YELLOW')}")
        sys.exit(1)
    except Exception as e:
